...
function wpbootstrap_scripts_with_jquery()
{
    ...
    wp_register_script( 'custom-script', get_template_directory_uri() . '/js/zanblog.js', array( 'jquery' ) );
...
function get_post_img($width="100",$height="100",$sizeTag=2) {   
    ...
    if(empty($matches[1][0])){
        ...
        $first_img = '<img src="'. get_bloginfo('template_url') .'/images/random/article'.rand(1,5).'.jpg" alt="'.$post->post_title .'" width="'.$width.'" height="'.$height.'"/>';
...
add_image_size('medium', 110, 110,true);
 function catch_first_image() {
  ...
  if(empty($first_img)){
        ...
        echo '/images/random/article'.$random.'.jpg';
  }
  return $first_img;
 }
